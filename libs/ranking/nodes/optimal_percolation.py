...
class OptimalPercolation(NodeRanking):
    ...
    def __init__(self, G):
        super(OptimalPercolation, self).__init__(G)
    ...
    def _best_percolation(self, scores_ball):
        ...
        print('Best l:{}, {} nodes out of {} total nodes'.format(best[1][0],best[0],self.G.number_of_nodes()))
        return best[1][1]
